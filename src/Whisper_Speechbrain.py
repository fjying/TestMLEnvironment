...
def main():
    ...
    classifier = EncoderClassifier.from_hparams(source=os.path.join(directory_path, 'models/Speechbrain', 'EncoderClassifier'))
    verification = SpeakerRecognition.from_hparams(source=os.path.join(directory_path, 'models/Speechbrain', 'SpeakerRecognition'))
